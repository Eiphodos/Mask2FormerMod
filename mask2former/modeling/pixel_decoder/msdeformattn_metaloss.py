...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def forward_features(self, features, meta_losses, meta_loss_coords):
        srcs = []
        pos = []
        ...
        return self.mask_features(out[-1]), out[0], multi_scale_features, meta_losses, meta_loss_coords
